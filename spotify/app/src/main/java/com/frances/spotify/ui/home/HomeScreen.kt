...
fun HomeScreen(viewModel: HomeViewModel, onTap: (Album) -> Unit) {
    ...
    // Compose a state:
    // val name by remember {mutableStateOf("tim")}
    // val (name, setName) = remember {mutableStateOf("tim")}
    // setName("tim1")
...
@Composable   // This annotation informs the Compose compiler that this function is intended to convert data into UI
